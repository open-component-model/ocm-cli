[![REUSE status](https://api.reuse.software/badge/github.com/open-component-model/ocm-cli)](https://api.reuse.software/info/github.com/open-component-model/ocm-cli)
